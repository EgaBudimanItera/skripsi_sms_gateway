  ...
  default:
    echo "<h2>Data Customer</h2>
          ";
              ...
              echo"<table>
              <tr><th>No</th><th>Nama Customer</th><th>email</th><th>Telepon</th><th>Nama Toko</th><th>Alamat</th><th>Aksi</th></tr>"; 
        ...
        while ($r=mysql_fetch_array($tampil)){
           ...
           echo "<tr ><td>$no</td>
				 ...
				 <td>$r[nama_toko]</td>
				 <td>$r[alamat]</td>
                 <td><a href=$aksi?module=$module&act=hapus&id=$r[id_kustomer] onclick=\"return konfirmasi('".$r[nama_lengkap]."')\"><b>Hapus</b></a></td>
				 </tr>";
          $no++;
        }
      echo "</table>";
