...
switch($_GET[act]){
  default:
    ...
    $tampil=mysql_query("SELECT * FROM kota,shop_pengiriman where kota.id_perusahaan=shop_pengiriman.id_perusahaan ORDER BY shop_pengiriman.nama_perusahaan,kota.id_kota ASC");
    $no=1;
       ...
       echo "<tr><td>$no</td>
	     ...
	     <td>$r[nama_perusahaan]</td>
             ...
             <td><a href=?module=ongkoskirim&act=editongkoskirim&id=$r[id_kota]><b>Edit</b></a> | 
	               <a href=$aksi?module=ongkoskirim&act=hapus&id=$r[id_kota] onclick=\"return konfirmasi('".$r[nama_kustomer]."')\"><b>Hapus</b></a>
             </td></tr>";
      $no++;
    }
    echo "</table>";
